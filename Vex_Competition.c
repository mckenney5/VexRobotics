...
#pragma config(Motor,  port3,           RDrive,        tmotorVex393_MC29, PIDControl, encoderPort, I2C_2)
#pragma config(Motor,  port4,           LArm,          tmotorVex393_MC29, PIDControl, encoderPort, I2C_3)
#pragma config(Motor,  port5,           RArm,          tmotorVex393_MC29, PIDControl, encoderPort, I2C_4)
